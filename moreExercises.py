...
# "Wrist_Roller", "Wrist_Rotations_with_Straight_Bar", "Yoke_Walk", "Zercher_Squats", "Zottman_Curl", "Zottman_Preacher_Curl"

# texto.replace("changed mechanicsType to be simply mechanic", "")
